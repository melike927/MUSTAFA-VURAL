const DEFAULT_CONTENT = {
  ...
  index: {
    ...
    detailCards: [
      {
        ...
        text: "Pazartesi - Cumartesi: 09:00 - 19:00",
      },
      {
        title: "Uzman Yaklasim",
        text: "Alanında deneyimli diş hekimleri ile kişiye özel tedavi planlaması.",
      },
      {
        title: "Hasta Konforu",
        text: "Modern klinik altyapısı, steril ortam ve şeffaf bilgilendirme süreçleri.",
      },
    ],
    buttons: [
    ...
    contactCards: [
      ...
      {
        title: "Telefon",
        text: "+90 555 555 00 00",
      },
      {
        title: "E-posta",
        text: "iletisim@mustafavuraldis.com",
      },
    ],
