const DEFAULT_CONTENT = {
  ...
  services: {
    ...
    cards: [
      { title: "Genel Dis Muayenesi", text: "Düzenli kontrol, erken teşhis ve kişisel ağız bakım planı oluşturma." },
      { title: "Estetik Dis Hekimligi", text: "Gülüş tasarımı, diş beyazlatma ve estetik restorasyon uygulamaları." },
      { title: "Ortodontik Degerlendirme", text: "Diş dizilimi ve çene yapısına yönelik kapsamlı analiz ve yönlendirme." },
  ...
  reviews: {
    ...
    intro: "Hasta memnuniyeti bizim icin en onemli gostergedir. Asagidaki yorumlar, klinigimizde tedavi olan danisanlarimizin deneyimlerinden secilmis orneklerdir.",
    cards: [
      { name: "Ayse K.", rating: "5/5", meta: "★★★★★ | Dogrulanmis Hasta | 02.03.2026", avatar: "assets/images/female-profile-logo.svg", text: "Ilk muayeneden itibaren cok acik bilgilendirildim. Tedavi sureci planli ve rahat gecti." },
      { name: "Mehmet T.", rating: "5/5", meta: "★★★★★ | Dogrulanmis Hasta | 17.02.2026", avatar: "assets/images/male-profile-logo.svg", text: "Implant tedavimde ekip son derece ilgiliydi. Hijyen ve ilgi konusunda gercekten cok iyiler." },
      { name: "Selin D.", rating: "4.9/5", meta: "★★★★☆ | Dogrulanmis Hasta | 29.01.2026", avatar: "assets/images/female-profile-logo.svg", text: "Cocuk dis hekimligi randevusunda kizim cok rahatti. Hekimlerin iletisimi cok basariliydi." },
      { name: "Emre Y.", rating: "5/5", meta: "★★★★★ | Dogrulanmis Hasta | 12.01.2026", avatar: "assets/images/male-profile-logo.svg", text: "Randevu planlama hizliydi, islemler zamaninda basladi. Gulus tasarimi sonucumdan memnunum." },
    ],
  },
  appointment: {
    title: "ONLINE RANDEVU",
    slogan: "Dakikalar icinde randevu talebi olusturun, ekibimiz size hizla donus yapsin.",
    intro: "Online randevu panelinden ihtiyac duydugunuz tedavi turunu secerek kolayca talep olusturabilirsiniz. Uygun saat secimi sonrasinda ekibimiz en kisa surede sizinle iletisime gecer.",
    quickCards: [
      { title: "Genel Muayene Randevusu", image: "https://images.unsplash.com/photo-1629909615184-74f495363b67?auto=format&fit=crop&w=700&q=80", alt: "Genel muayene randevusu" },
      { title: "Estetik Tedavi Randevusu", image: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&w=700&q=80", alt: "Estetik dis tedavisi randevusu" },
      { title: "Cocuk Dis Hekimligi", image: "https://images.unsplash.com/photo-1598256989800-fe5f95da9787?auto=format&fit=crop&w=700&q=80", alt: "Cocuk dis hekimligi randevusu" },
    ],
    steps: [
      { title: "1. Tedavi Turunu Secin", text: "Ihtiyaciniza uygun randevu turunu secerek sureci baslatin." },
      { title: "2. Saat Talebi Olusturun", text: "Size uygun tarih ve saat araligini belirterek formu tamamlayin." },
      { title: "3. Onay Bilgisi Alin", text: "Ekibimiz tarafindan randevu onayi telefon veya mesaj ile iletilir." },
      { title: "4. Kliniğe Gelis", text: "Randevu saatinde kliniğe gelerek tedavi surecinizi baslatabilirsiniz." },
    ],
    formNote: "Form, webhook veya Google Sheets baglantisi icin hazirdir.",
    treatmentOptions: ["Genel Muayene", "Estetik Dis Tedavisi", "Cocuk Dis Hekimligi", "Implant Tedavisi"],
  },
  kvkk: {
    title: "KVKK",
    intro: "Kisisel verileriniz, 6698 sayili Kisisel Verilerin Korunmasi Kanunu kapsaminda sadece saglik hizmeti sunumu, randevu yonetimi ve yasal yukumluluklerin yerine getirilmesi amaciyla islenmektedir.",
    cards: [
  ...
  emergency: {
    ...
    intro: "Siddetli agrı, travma, kirik dis veya kanama gibi durumlarda 7/24 danisma hattimizi arayabilirsiniz.",
    cards: [
